...
transaction {
    prepare(acct: AuthAccount) {
        ...
        acct.link<&{TriQuetaNFT.NFTContractCollectionPublic, MetadataViews.ResolverCollection}>(TriQuetaNFT.CollectionPublicPath, target:TriQuetaNFT.CollectionStoragePath)
